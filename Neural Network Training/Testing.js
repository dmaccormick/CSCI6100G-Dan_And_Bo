...
const OnGenerateCSSButton = () =>
{
    ...
    newButton.id = 'AIGeneratedButton';
    ...
    // // Create a style tag so we can put the CSS rules in
    // const styleTag = document.createElement('style');
    // document.body.appendChild(styleTag);

    // // Add all of the styling to the button as generated by the AI, using its ID
    // styleTag.sheet.insertRule("#AIGeneratedButton {background: lightgreen;}", 0);
}